...
import static cu.z17.views.utils.blurhash.Utils.linearTosRGB;
import static cu.z17.views.utils.blurhash.Utils.max;
import static cu.z17.views.utils.blurhash.Utils.sRGBToLinear;
import static cu.z17.views.utils.blurhash.Utils.signPow;
...
public final class BlurHash {
    ...
    public static String encode(Bitmap bufferedImage, int componentX, int componentY) {
        ...
        bufferedImage.getPixels(pixels, 0, width, 0, 0, width - 1, height - 1);
